...
const mobilePageData = [
    ...
    },
    {
        title: "Dry Socket",
        content:
            "A dry socket has the potential to cause intense discomfort and pain following a tooth extraction. At Carrum Downs Dental Group, we specialize in effectively managing this condition, offering relief from the distressing pain it can bring.",
        imageSrc: DrySocket,
    ...
    },
    {
        ...
        content:
            "Losing a tooth can be distressing and painful. At Carrum Downs Dental Group, our experienced dentists know how to properly treat knocked-out teeth. We utilize advanced techniques to reimplant and stabilize the tooth so you can smile confidently again.",
    ...
    },
    {
        ...
        content:
            "Severe tooth pain can be agonizing, leaving you desperate for relief. At Carrum Downs Dental Group, we understand how debilitating toothaches can be. Our experienced dentists and staff are dedicated to addressing severe tooth pain quickly yet gently.",
