...
// import Banner from '../../public/privacy-policy/privacy.jpg'
...
"
                      ...
                      <Typography className="para">
                        At Carrum Downs Dental Group, we are committed to
                        respecting your privacy and are committed to protecting
                        your personal information. Our dental practice is bound
                        by relevant Health Privacy Principles in state
                        legislation and Commonwealth National Privacy Principles
                    ...
                    <Box className="mt-4">
                      ...
                      <Typography className="para">
                        ...
                        can provide you with the best healthcare.
                      </Typography>
                      <Typography className="para">
                        In case of any changes in your health and medical
                        information, you should notify the dental practice
                        promptly. This includes medications and any natural
                        alternatives you may be taking. Failure to provide this
                        updated information may lead to the following but are
                        not limited to: We may not be able to provide the best
                        health care;
                      </Typography>
                      <Typography className="para">
                      ...
                      <Typography className="para">
                        Please contact us below if you believe that your
                        personal information is inaccurate,incomplete, or out of
                        date.
                      </Typography>
                    </Box>
                    <Box className="mt-4">
                      ...
                      <Box>
                        <List className="p-0">
                          <ListItem>
                            ...
                            <ListItemText primary="Confidential agreements for all of our employees" />
                          </ListItem>
                          <ListItem>
                            <ListItemIcon>
                              <CheckCircleOutline
                            ...
                            <ListItemText primary="Security policies for all document storage" />
                          </ListItem>
                          <ListItem>
                            <ListItemIcon>
                              <CheckCircleOutline
                            ...
                            <ListItemText primary="System access security measures" />
                          </ListItem>
                          <ListItem>
                            <ListItemIcon>
                              <CheckCircleOutline
                            ...
                            <ListItemText primary="Providing a discrete environment for all confidential discussions within the dental clinic" />
                          </ListItem>
                          <ListItem>
                            <ListItemIcon>
                              <CheckCircleOutline
                            ...
                            <ListItemText primary="Personal information transfers are only allowed when the initial seeking access provides written consent." />
                          </ListItem>
                          <ListItem>
                            <ListItemIcon>
                              <CheckCircleOutline
                            ...
                            <ListItemText primary="Controlled access to all of our buildings" />
                          </ListItem>
                          <ListItem>
                            <ListItemIcon>
                              <CheckCircleOutline
                            ...
                            <ListItemText primary="Electronic records systems for records backups on cloud storage providers located outside Australia" />
                          </ListItem>
                        </List>
                      </Box>
                    </Box>
                    <Box className="mt-4">
                      <SectionalHeading
                        ...
                        align="left"
                        color="var(--dark-blue)"
                        title="Your privacy on the internet"
                      />
                      <Box mt={2}>
                        <SectionalHeading
                          variant="h3"
                      ...
                      <Box>
                        <List className="p-0">
                          <ListItem>
                            ...
                            <ListItemText primary="You are always welcome to communicate directly with any member of our staff, and they will help you to the best of their abilities." />
                          </ListItem>
                          <ListItem>
                            <ListItemIcon>
                              <CheckCircleOutline
                            ...
                            <ListItemText primary="You can talk to your treating dental practitioner to resolve your issue." />
                          </ListItem>
                          <ListItem>
                            <ListItemIcon>
                              <CheckCircleOutline
                            ...
                            <ListItemText primary="You can contact the dental practice principal owner via the contact details provided on the website." />
                          </ListItem>
                          <ListItem>
                            <ListItemIcon>
                              <CheckCircleOutline
                            ...
                            <ListItemText primary="If the issue is not resolved to your satisfaction via any of our communication channels, you can always let us know, and we will investigate the specific case and keep you advised of progress. If such channels still don’t bear any progress, the issue will be escalated to the appropriate channels to facilitate resolution." />
                          </ListItem>
                        </List>
                      </Box>
                    </Box>
                    ...
                    <Box className="mt-4">
                      ...
                      <Typography className="para">
                        We will not disclose or use personal information for
                        other purposes without your express consent unless
                        required to disclose by the law. If you believe that we
                        have failed to adhere to the principles in this [privacy
                        statement or you have any comments on the privacy
                        policy, please get in touch with us @
                        carrumdowsndental@gmail.com
                      </Typography>
                    </Box>
                    <Box className="mt-4">
                      <SectionalHeading
