...
const PattersonLake = () => {
  ...
  return (
    <>
      ...
      <CommonHero bg={Banner} breadcrumb={breadcrumb} title="Dentist In Patterson Lakes" align='left' color="#fff" />
      {
        show ? <><main>
                  ...
                  <Grid container spacing={5}>
                    <Grid item xs={12} lg={8}>
                      ...
                      <section className='mt-4 bg-grey p-2'>
                        <Container maxWidth="xxl">
                          <Typography variant='h3' className='fs-3 heading-color mb-2'>Why Visit Our Carrum Downs Clinic?</Typography>
