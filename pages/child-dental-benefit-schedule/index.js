...
const CDBS = () => {
  return (
    <>
      ...
      <PPCBanner
        bg={Banner}
        title="Grow Up Smiling"
        tagline=" Child Dental Benefit Schedule (CDBS)"
        align="start"
      />
      <main>
        <section>
                    ...
                    >
                      <Box>
                        ...
                        <Typography className="para">
                          ...
                          treatment costs under this program for eligible kids.
                        </Typography>
                        <Typography className="para">
                          If you are not sure if you are eligible just give us a
                          call and provide your medicate number. We will be able
                          to confirm if you are eligible.
                        </Typography>
                        <Typography className="para">
                          At Carrum Downs Dental Group we have a play area for
                          kids to engage themselves before the treatment. Also,
                          during the treatment we can provide the child with
                          distraction or entertainment with Kids channels or
                          Movies while we gently complete the dental treatment.
                        </Typography>
                      </Box>
                    </Grid>
                  ...
                  <Grid container spacing={5}>
                    ...
                    >
                      <Box>
                        ...
                        <List>
                          {[
                            "Just book an appointment with us and let us know if you are eligible for claiming this benefit. If you are unsure we can check the eligibility on your behalf with you Medicare card number.",
                            "Bring your medicare card along for your appointment",
                            "After your appointment we will bulk bill your treatment costs and this means you don’t need to pay from your pocket.",
                          ].map((item) => (
                            <ListItem key={item}>
                              <ListItemIcon>
                                <CheckCircleOutline
