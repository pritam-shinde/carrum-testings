...
export const getServerSideProps = async (context) => {
  ...
  const res = await fetch(
    `https://apicarrumdownsdental.myconcept.website/wp-json/wp/v2/posts?_embed=true&page=${pageNo}`
  );
    ...
    <>
      {show ? (
        <>
          <Head>
            <title>
              Blog | Carrum Downs Dental Group | Dentist Carrum Downs {pageNo}
            </title>
            <meta
              name="description"
              content={`Our blog contains various posts related to the dental conditions, treatments and vouchers. Read our blogs for dental tips and be aware of the dental problems ${pageNo}.`}
            />
                  ...
                  <Box py={5}>
                    <Grid container spacing={5}>
                      <Grid item xs={12} lg={8}>
                        ...
                        >
                          ...
                          {data && data.length > 0 && (
                            <>
                              <BlueOulinedBtn
                                btnLink={`/blog/page/${Number(pageNo) + 1}/`}
                                btnTitle="NEXT"
                                navlink={true}
                              />
                              {pageNo > 1 && (
                      ...
                      <Grid item xs={12} lg={4}>
                        {data && category ? (
                          <BlogSidebar blogs={latestBlog} cat={category} />
                        ) : null}
                      </Grid>
                    </Grid>
                  </Box>
...
//             <link rel="canonical" href={`/blog/page/${pageNo}/`} />
//           </Head>
//           <CommonHero title="Blog" breadcrumb={breadcrumb} bg={Banner[randomBanner]} color={"#fff"} />
//           <main>
//             <Container maxWidth="xxl">
//               <Grid container>
//                 <Grid item xs={12} md={10} className="mx-auto">
