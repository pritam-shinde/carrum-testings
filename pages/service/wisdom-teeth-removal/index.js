...
const WisdomTeeth = ({ data }) => {
  ...
  return (
    <>
      <Head>
        <title>
          Wisdom Teeth Removal Treatment | Carrum Downs Dental Group
        </title>
        <meta
          name="description"
          content="We have experienced & specialized in wisdom teeth removal dentists in Carrum Downs. Now don't suffer from symptoms of wisdom tooth extraction. Call Us now!"
        />
                  ...
                  <Box py={5}>
                    <Grid container spacing={3}>
                      <Grid item xs={12} lg={8}>
                        <section>
                          <Container maxWidth="1600px" className="p-0">
                            <SectionalHeading
                              variant="h2"
                              align="left"
                              title="Wisdom Tooth and Other Surgical Extractions"
                              color="var(--dark-blue)"
                            />
                            {[
                            ...
                            <Box my={3}>
                              ...
                              >
                                {[
                                  ...
                                  {
                                    id: "new-wisdom-tooth-x-ray",
                                    image: Slider3,
                                  },
                                  {
                                    id: "wisdom-tooth-improper-positioning",
                                    image: Slider4,
                                  },
                                ].map((item) => (
                                ...
                                >
                                  <div className="accordion-item">
                                    ...
                                    >
                                      <div className="accordion-body">
                                        <p className="para">
                                          A wisdom tooth can be removed for
                                          various reasons, such as a wisdom
                                          tooth that failed to erupt fully,
                                          chronic pain on the gums around the
                                          wisdom tooth, a tooth that didn’t come
                                          out straight or a wisdom tooth causing
                                          decay to the adjacent teeth.
                                        </p>
                                      </div>
                                    </div>
                                  </div>
                                  <div className="accordion-item">
                                    ...
                                    >
                                      <div className="accordion-body">
                                        <p className="para">
                                          Yes, wisdom teeth removal is covered
                                          under Medicare for eligible Kids under
                                          the{" "}
                                  ...
                                  <div className="accordion-item">
                                    ...
                                    >
                                      <div className="accordion-body">
                                        <p className="para">
                                          Following wisdom teeth removal, you
                                          should eat soft foods and liquids such
                                          as yoghurt, mashed potatoes, pudding
                                          and smoothies. Cold foods like ice
                                          cream can offer relief.
                                        </p>
                                      </div>
                                    </div>
                                  </div>
