  ...
  return (
    <>
      ...
      <CommonHero
        ...
        title="Computer Guided Dental Implants in Carrum Downs"
                      ...
                      <section>
                        <Container maxWidth="xxl" className="p-0">
                            ...
                            <List>
                              <ListItem className="ps-0">
                                ...
                                <ListItemText
                                  primary={
                                    <strong>
                                      Complete Dental Implants with Crown
                                      normally $4500* is special on $3900*.
                                    </strong>
                                  }
                                />
                              </ListItem>
                          ...
                          <Typography className="para">
                            Dental Implants with Crown have quickly become a
                            very effective way for patients to deal with tooth
                            loss. The dental Implants along with restoring the
                          ...
                          <Typography className="para">
                            ...
                            it will make it appear and function as a normal
                            tooth and provides up to 90% chewing capacity.
                          </Typography>
                        </Container>
                      </section>
                                    ...
                                    <ListItemText
                                      primary={
                                        <>
                                          ...
                                          alternative for{" "}
                                          <a href="/service/missing-teeth/">
                                            missing teeth
                                          </a>
                                          , because they offer a permanent
                                          solution.
                                        </>
                                      }
                                    />
                            ...
                            <Box mt={1}>
                              ...
                              <Box mt={1} className="ratio ratio-16x9">
                                <iframe
                                  width="560"
                                  height="315"
                                  src="https://www.youtube.com/embed/tvXccIIeBeI"
                              ...
                              <div className="accordion" id="accordionExample">
                                <div className="accordion-item">
                                  ...
                                  >
                                    <div className="accordion-body">
                                      <p className="para">
                                        Dental implants are considered the best
                                        alternative for lost teeth because they
                                        can last for a lifetime. With regular
                                        brushing, flossing and dental check-ups,
                                        they can offer a permanent solution. The
                                        crown, however, only lasts between 10 to
                                        15 years before needing a replacement.
                                      </p>
                                    </div>
                                  </div>
                                </div>
                                <div className="accordion-item">
                                  ...
                                  >
                                    <div className="accordion-body">
                                      <p className="para">
                                        The procedure of{" "}
                                        <a href="/top-5-common-myths-and-facts-of-dental-implants/">
                                          dental implants
                                        </a>{" "}
                                        is not painful since it’s performed with
                                        anaesthesia to numb the site of the
                                        implant. After the procedure, however,
                                        some patients may experience a mild,
                                        which can be relieved using painkillers.
                                      </p>
                                    </div>
                                  </div>
                                </div>
                                <div className="accordion-item">
                                  ...
                                  >
                                    <div className="accordion-body">
                                      <p className="para">
                                        The time it takes to complete a dental
                                        implant surgery varies based on the
                                        technique your dentist decides to use
                                        and the location of the implant.
                                        Generally, it takes about 1 hour to
                                        place the implant.
                                      </p>
                                    </div>
                                  </div>
                                ...
                                <div className="accordion-item">
                                  ...
                                  >
                                    <div className="accordion-body">
                                      <p className="para">
                                        Dental implants have been done safely
                                        for over 50 years with up to 98% success
                                        rate. This means it’s safe for almost
                                        anyone so long as your oral health is
                                        good.
                                      </p>
                                    </div>
                                  </div>
