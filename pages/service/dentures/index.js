...
const Denture = ({ data }) => {
  ...
  return (
    <>
      <Head>
        <title>
          Dentures in Carrum Downs | Carrum Downs Dental Group Clinic
        </title>
        <meta
          name="description"
          content="Dentist in Carrum Downs Dental Group has extensive denture experience that satisfies every patient’s denture needs. We provide high quality of dentures."
        />
                      ...
                      <section>
                        <Container maxWidth="xxl" className="p-0">
                          <Box>
                            <SectionalHeading
                              variant="h2"
                              title="We offer the best solutions for Dentures."
                              align={width < 600 ? "center" : "left"}
                              color="var(--dark-blue)"
                            />
                            <Box my={1}>
                              <Grid container spacing={2}>
                                ...
                                <Grid item xs={12} md={6}>
                                  <Image
                                    src={Denture2}
                                    alt="Denture Dentist with Patient"
                                  />
                                </Grid>
                              </Grid>
                            </Box>
                            <Typography className="para">
                              ...
                              individual patient’s specific denture needs. We
                              work with you to determine your exact requirements
                              and what is required to meet them. We at Carrum
                              Downs Dental Group take pride in the quality of
                              our Dentures.
                            </Typography>
                            <Typography className="para">
                          ...
                          <Box p={3}>
                            <Box>
                              ...
                              <Typography className="para">
                                ...
                                removable. With the technological advancements
                                there are several types of Dentures available to
                                suit individual patient’s needs on comfort,
                                convenience and look. Your Dentist will help you
                      ...
                      <section className="mt-md-5 mt-4">
                        <Container maxWidth="xxl" className="p-0">
                          <Box>
                            <SectionalHeading
                              variant="h2"
                              title="Denture procedure at Carrum Downs Dental Group:"
                              align={width < 600 ? "center" : "left"}
                              color="var(--dark-blue)"
                            />
                            <Typography className="para">
                              The exact denture procedure needed will vary with
                              the type of denture needed. However the procedure
                              will usually revolve around the following. You
                              have an Initial Consultation with your dentist to
                              assess your mouth for treatment planning.
                            </Typography>
                            <Box>
                              <List>
                                <ListItem className="ps-0">
                                ...
                                <ListItem className="ps-0">
                                  ...
                                  <ListItemText>
                                    With help from your dentist you can decide
                                    which tooth shapes, sizes and colours fit
                                    your mouth and look right for you. Your
                                    ‘bite’ is also recorded by the dentist. In
                                    the case of complete dentures the dentist
                                    records where the bite of the{" "}
                                    <a href="/service/digital-dentures/">
                                      new dentures
                                    </a>{" "}
                                    needs to be. Our dentist works with you to
                                    get this accurately.
                                  </ListItemText>
                                </ListItem>
                                <ListItem className="ps-0">
                            ...
                            <Typography className="para">
                              <strong style={{ color: "var(--dark-blue)" }}>
                                At Carrum Downs Dental we use Australian owned
                                and licensed dental labs in Melbourne. The
                                dental lab technician creates your dentures in
                                the lab. She works closely with our dentist to
                                gain the desired result. Using a local dental
                                lab allows us to provide you with your dentures
                                in a timely manner.
                              </strong>
                            </Typography>
                          </Box>
                              ...
                              <div className="accordion" id="accordionExample">
                                <div className="accordion-item">
                                  ...
                                  >
                                    <div className="accordion-body">
                                      <p className="para">
                                        Depending on the denture being Acrylic
                                        or Chrome (metal), the cost for a single
                                        arch can vary from $700 to $1300.
                                      </p>
                                    </div>
                                  </div>
                                </div>
                                <div className="accordion-item">
                                  ...
                                  >
                                    <div className="accordion-body">
                                      <p className="para">
                                        Dentures need to be removed for proper
                                        cleaning. Soak and brush things using a
                                        soft-bristled brush and a denture
                                        antibacterial cleaner to remove food,
                                ...
                                <div className="accordion-item">
                                  ...
                                  >
                                    <div className="accordion-body">
                                      <p className="para">
                                        Oftentimes, a broken or chipped denture
                                        can be easily repaired. Your dentist
                                        removes the damaged tooth, takes proper
                                        measurements and replaces it to match
                                        the rest of the denture.
                                      </p>
                                    </div>
                                  </div>
                                </div>
                                <div className="accordion-item">
                                  ...
                                  >
                                    <div className="accordion-body">
                                      <p className="para">
                                        You can sleep and eat with a partial
                                        denture without any problem. However,
                                        sometimes it might feel more comfortable
                                        to take it off when you sleep, but
                                        that’s up to you.
                                      </p>
                                    </div>
                                  </div>
